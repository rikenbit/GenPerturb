## modified : https://github.com/lucidrains/enformer-pytorch/tree/main
...
from genperturb.dataloaders._alphagenome_sequence import alphagenome_sequence_key
...
class GenomeIntervalDataset(Dataset):
    ...
    def get_interval_key(self, ind):
        interval = self.df.row(ind)
        chr_name, start, end = (interval[0], interval[1], interval[2])
        chr_name = self.chr_bed_to_fasta_map.get(chr_name, chr_name)
        return alphagenome_sequence_key(chr_name, start, end)
